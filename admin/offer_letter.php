                            ...
                            <table id="datatable-buttons" class="table table-striped table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <form class="form-horizontal"  enctype="multipart/form-data" role="form" action="actions/submit-letter.php" method="POST" enctype="multipart/form-data">
                                        <td style="text-align: center;">
                                            <input type="file" class="filestyle" data-buttonbefore="true" name="letter">
                                            <br>
                                            <input type="hidden" class="user" value="<?php echo $row['applicantsid']; ?>" name="userID">
                                            <button type="submit" class="btn btn-primary center" name="submit">Upload</button>
                                        </td>
                                        </form>
                                    </tr>
                                <?php } ?>
