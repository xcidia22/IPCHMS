                            ...
                            <?php 
                                if(isset($_POST['submit'])) {
                                    ...
                                    $category = $_POST['category'];
                                            ...
                                            $match = $dbh->prepare("SELECT * FROM `school_details` INNER JOIN `courses` ON `school_details`.`school_id`=`courses`.`school_id` WHERE `school_country`='".$country."' AND `category` = '".$category."'");
