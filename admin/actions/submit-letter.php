...
mysqli_close($con);
        ...
        $check = $_FILES['letter'];
        $temp1 = explode(".", $_FILES["letter"]["name"]);
                $file1 = "letter".'.'.end($temp1);
        
            date_default_timezone_set("Asia/Manila");
            $dateNow = date('Y-m-d');
            $timeNow = date('h:i:s');
            $insertLog = $dbh->prepare("INSERT INTO logs(`log_description`, `date`, `time`) VALUES('".$givenname." ".$lastname." - Letter Submitted','".$dateNow."','".$timeNow."')");
                $insertLog->execute();
        ...
        if(end($temp1)!=""){
            ...
            if ($uploadOk1 == 1 && $imageFileType1 == "jpg" || $imageFileType1 == "jpeg" || $imageFileType1 == "png" ) {
                if (move_uploaded_file($_FILES["letter"]["tmp_name"], $temp_file1)) {
                    $file_1 = true;
                    ...
                    (function() {
                        ...
                        window.alert = function() {
                            swal({
                                ...
                                setTimeout(function(){location.href="../offer_letter.php";} , 500);   
                            })
                        };
                        })();
                        alert();
